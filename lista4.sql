...
--G
SELECT PRODUCT.NMPRODUCT, 
COUNT(PRODUCTREQUEST.CDPRODUCT) AS VEZESPEDIDO,
...
(PRODUCTREQUEST.VLUNITARY * PRODUCTREQUEST.QTAMOUNT) AS VLGASTO,
COUNT(DISTINCT(PRODUCTREQUEST.CDPRODUCT)) AS VZPEDIDO,
SUPPLIER.NMSUPPLIER
...
WHERE  (PRODUCTREQUEST.VLUNITARY * PRODUCTREQUEST.QTAMOUNT) > 1000

GROUP BY NMPRODUCT, NMSUPPLIER, NMCUSTOMER, PRODUCTREQUEST.VLUNITARY, PRODUCTREQUEST.QTAMOUNT
